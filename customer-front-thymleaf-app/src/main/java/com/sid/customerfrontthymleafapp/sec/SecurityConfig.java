package com.sid.customerfrontthymleafapp.sec;
...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception{
        return http
                ...
                .authorizeHttpRequests(request -> request.requestMatchers("/", "/webjars/**","/h2/console/**").permitAll())
                .authorizeHttpRequests(request -> request.anyRequest().authenticated())
                .oauth2Login(al->al.loginPage("/oauth2Login").permitAll().defaultSuccessUrl("/"))
